...
from graph import NodeConnectionGraph
...
class ConnectomeBlock(nn.Module):
    def __init__(self, node_num, p, in_channels, out_channels, graph_mode, graph_type, is_train, name):
        super(ConnectomeBlock, self).__init__()
        ...
        graph_node = NodeConnectionGraph(self.node_num, self.p, graph_mode=graph_mode, graph_type=graph_type)
