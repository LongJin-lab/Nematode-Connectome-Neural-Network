...
parser.add_argument('-d', '--data', default='/media_SSD_1/datasets/imagenet/', type=str)
...
def main():
    ...
    model = Model(16, 0.75, 78, 78, "NCNN", "ncnn16.xlsx", "IMAGENET", True)
    #from models.resnet_img import resnet18
    #model = resnet18()
    model = model.cuda()
